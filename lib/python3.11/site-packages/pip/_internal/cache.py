...
class Cache:
    ...
    :param allowed_formats: which formats of files the cache should resource.
    ...
    def get_path_for_link(self, link: Link) -> str:
        """Return a directory to resource cached items in for link."""
...
class SimpleWheelCache(Cache):
    ...
    def get_path_for_link(self, link: Link) -> str:
        """Return a directory to resource cached wheels for link
